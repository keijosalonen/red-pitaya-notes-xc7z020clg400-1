...
(* CORE_GENERATION_INFO = "system,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=system,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=20,numReposBlks=20,numNonXlnxBlks=11,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=Global}" *) (* HW_HANDOFF = "system.hwdef" *) 
module system
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [31:0]cntr_0_m_axis_TDATA;
  wire cntr_0_m_axis_TREADY;
  wire cntr_0_m_axis_TVALID;
  wire [63:0]concat_0_dout;
  wire [0:0]const_0_dout;
  wire [31:0]const_1_dout;
  wire [13:0]const_2_dout;
  wire dac_0_dac_clk;
  ...
  wire [21:0]hub_0_b00_bram_ADDR;
  wire hub_0_b00_bram_CLK;
  wire [31:0]hub_0_b00_bram_DIN;
  wire [31:0]hub_0_b00_bram_DOUT;
  wire hub_0_b00_bram_EN;
  wire [3:0]hub_0_b00_bram_WE;
  wire [21:0]hub_0_b02_bram_ADDR;
  wire hub_0_b02_bram_CLK;
  wire [15:0]hub_0_b02_bram_DOUT;
  wire hub_0_b02_bram_EN;
  wire hub_0_b02_bram_RST;
  wire [95:0]hub_0_cfg_data;
  wire pll_0_clk_out1;
  wire pll_0_clk_out2;
  wire pll_0_clk_out3;
  wire pll_0_locked;
  ...
  wire [13:0]reader_0_b_bram_ADDR;
  wire reader_0_b_bram_CLK;
  wire [31:0]reader_0_b_bram_DOUT;
  wire reader_0_b_bram_EN;
  wire [31:0]reader_0_m_axis_TDATA;
  wire reader_0_m_axis_TREADY;
  wire reader_0_m_axis_TVALID;
  wire [0:0]rst_0_peripheral_aresetn;
  wire [0:0]slice_0_dout;
  wire [7:0]slice_1_dout;
  wire [15:0]slice_2_dout;
  wire [15:0]slice_3_dout;
  ...
  system_bram_0_0 bram_0
       (.addra(hub_0_b00_bram_ADDR[13:0]),
        .addrb(reader_0_b_bram_ADDR),
        .clka(hub_0_b00_bram_CLK),
        .clkb(reader_0_b_bram_CLK),
        .dina(hub_0_b00_bram_DIN),
        ...
        .douta(hub_0_b00_bram_DOUT),
        .doutb(reader_0_b_bram_DOUT),
        .ena(hub_0_b00_bram_EN),
        .enb(reader_0_b_bram_EN),
        .wea(hub_0_b00_bram_WE),
        .web({1'b0,1'b0,1'b0,1'b0}));
  system_cntr_0_0 cntr_0
       (.aclk(pll_0_clk_out1),
        .aresetn(rst_0_peripheral_aresetn),
        .cfg_data(const_1_dout),
        .m_axis_tdata(cntr_0_m_axis_TDATA),
        .m_axis_tready(cntr_0_m_axis_TREADY),
        .m_axis_tvalid(cntr_0_m_axis_TVALID));
  system_concat_0_0 concat_0
       (.In0({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,fifo_0_read_count}),
        .In1(dsp_0_P),
        .dout(concat_0_dout));
  ...
  system_dac_0_0 dac_0
       (.aclk(pll_0_clk_out1),
        ...
        .locked(pll_0_locked),
        .s_axis_tdata(reader_0_m_axis_TDATA),
        .s_axis_tready(reader_0_m_axis_TREADY),
        .s_axis_tvalid(reader_0_m_axis_TVALID),
        .wrt_clk(pll_0_clk_out3));
  system_dsp_0_0 dsp_0
       (.A(slice_2_dout),
        .B(slice_3_dout),
        .CLK(pll_0_clk_out1),
        .P(dsp_0_P));
  ...
  system_hub_0_0 hub_0
       (.aclk(pll_0_clk_out1),
        .aresetn(rst_0_peripheral_aresetn),
        .b00_bram_addr(hub_0_b00_bram_ADDR),
        .b00_bram_clk(hub_0_b00_bram_CLK),
        .b00_bram_en(hub_0_b00_bram_EN),
        .b00_bram_rdata(hub_0_b00_bram_DOUT),
        .b00_bram_wdata(hub_0_b00_bram_DIN),
        .b00_bram_we(hub_0_b00_bram_WE),
        ...
        .b02_bram_rdata({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,hub_0_b02_bram_DOUT}),
        .b02_bram_rst(hub_0_b02_bram_RST),
        ...
        .s01_axis_tdata(cntr_0_m_axis_TDATA),
        .s01_axis_tready(cntr_0_m_axis_TREADY),
        .s01_axis_tvalid(cntr_0_m_axis_TVALID),
  ...
  system_reader_0_0 reader_0
       (.aclk(pll_0_clk_out1),
        .aresetn(rst_0_peripheral_aresetn),
        .b_bram_addr(reader_0_b_bram_ADDR),
        .b_bram_clk(reader_0_b_bram_CLK),
        .b_bram_en(reader_0_b_bram_EN),
        .b_bram_rdata(reader_0_b_bram_DOUT),
        .cfg_data(const_2_dout),
        .m_axis_tdata(reader_0_m_axis_TDATA),
        .m_axis_tready(reader_0_m_axis_TREADY),
        .m_axis_tvalid(reader_0_m_axis_TVALID));
  ...
  system_xadc_0_0 xadc_0
       (.Vaux0_n(Vaux0_1_V_N),
        ...
        .Vp_Vn_n(Vp_Vn_1_V_N),
        .Vp_Vn_p(Vp_Vn_1_V_P),
        .b_bram_addr(hub_0_b02_bram_ADDR[4:0]),
        .b_bram_clk(hub_0_b02_bram_CLK),
        .b_bram_en(hub_0_b02_bram_EN),
        .b_bram_rdata(hub_0_b02_bram_DOUT),
        .b_bram_rst(hub_0_b02_bram_RST));
endmodule
